...
$('#lookBtn').onclick=$('#missionLookBtn').onclick=showView;$('#closeViewer').onclick=closeView;$('#tutorialBtn').onclick=()=>$('#tutorial').classList.remove('hidden');$('#closeTutorial').onclick=$('#startTutorial').onclick=()=>$('#tutorial').classList.add('hidden');
